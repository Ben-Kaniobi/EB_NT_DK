...
\let\oldcite\cite
% \cite neu definieren, sodass Zähler jedesmal inkrementiert wird
...
%
% Tiefe der Gliederung (Nummerierung)
\setcounter{secnumdepth}{\tocmaxdepth}
% Tiefe der Gliederung (Auflistung)
