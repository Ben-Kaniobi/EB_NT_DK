...
\newcommand{\Uebertitel}    {Dokumentation - Projektarbeit 1 \& 2}
\newcommand{\AutorA}        {Nicola K\"aser}
\newcommand{\DozentA}       {M. Kucera}
\newcommand{\DozentB}       {I. Oesch}
...
% Maximale Tiefe der Verzeichnisöffnung im PDF
...
% Dokumentinhalt
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Neues command für "Projektarbeit"
\newcommand{\PA}[1]{Projektarbeit~#1}
%
...
%
% Seitenzahl umschalten auf alphabetisches Nummerieren (nur für Titelblatt)
\pagenumbering{Alph}
%
