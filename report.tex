...
% Flag ob ein Übersichtsverzeichnis erstellt werden soll
...
\thispagestyle{empty}
% Leere Seite nach Titelseite einfügen
\cleardoublepage
%
%
%
...
\ifthenbool{createShorttoc}{
	% Übersicht mit definierter Tiefe
...
%
% Recherche
\input{content/2_recherche}
%
% Evaluation und Entscheidung
\input{content/3_evaluation}
%
% Realisation
\input{content/4_realisation}
%
% Kontrolle
\input{content/5_kontrolle}
%
% Ergebnisse
\input{content/6_ergebnis}
%
% Pendenzen
\input{content/7_pendenzen}
%
% Schlussfolgerung
\input{content/8_schlusswort}
%
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Seitenzähler auf 0, damit die Seite 1 des Anhangs dann auch B-1
\setcounter{page}{0}
% Anhang B einfügen
