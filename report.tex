...
\documentclass[version=last,fleqn,pointlessnumbers]{scrreprt}
	...
	% pointlessnumbers: Kapitelnummerierung ohne Punkt;
...
% Optionen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Maximale Tiefe des Inhaltsverzeichnis und Tiefe der Verzeichnisöffnung im PDF
\newcommand{\tocmaxdepth}   {2}
% Wenn definiert, dann werden ein Abbildungs- und Tabellenverzeichnis erstellt
%\newboolean{includeLists}
%\setboolean{includeLists}	{true}
\newcommand{\includeLists}  {\true}
% Wenn definiert, dann wird ein Stichwortverzeichnis erstellt erstellt
%\newboolean{includeIndex}
%\setboolean{includeIndex}	{true}
\newcommand{\includeIndex}  {\true}
...
%
\ifdefined\includeLists
	% Kapitel ohne Nummerierung, aber in Inhaltsverzeichnis
	\chapternn{Abbildungs- und Tabellenübersicht}
