...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Redefinition von \cite, sodass bei jedem Aufruf ein Zähler inkrementiert
% wird. Dieser kann verwendet werden, damit das Quellenkapitel nur bei der
% Verwendung von \cite eingefügt wird (\ifnum\value{citenum}>0 ... \fi).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
