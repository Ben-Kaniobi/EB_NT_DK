...
\section{Software Set\_SRF08\_Address}
	...
	\subsection{SRF08 Adresse ändern}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Erneute Adressänderung ist möglich (= neue Adresse funktioniert)\dotfill \ok\platz
		\end{itemize}
		%
		\clearpage
		%
