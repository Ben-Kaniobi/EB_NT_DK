...
\section{Software Rangefinder}
	...
	\subsection{Infrarot Interrupt}
		\begin{itemize}
			...
			\begin{itemize}
				\item Flag für vorne links\dotfill A\ok
				\item Flag für vorne rechts\dotfill \ok
				\item Flag für hinten links\dotfill \ok
				\item Flag für hinten rechts\dotfill \ok
			\end{itemize}
	...
	\subsection{Ultraschall Task}
		\begin{itemize}
			...
			\begin{itemize}
				\item Flag für vorne\dotfill \ok
				\item Flag für hinten\dotfill \ok
				\item Flag für Separation\dotfill \ok
			\end{itemize}
			\item Sensoren setzen ohne Hindernis Alarm zurück:
			\begin{itemize}
	...
	\subsection{Notizen}
		\begin{enumerate}
			...
			\item Beim Sensor vorne links wurde kein Alarm ausgelöst. Die Ursache war aber eine Beschädigung des Infrarot-Prints bei der Montage. Dieses Problem wurde gleich behoben und der Test konnte sogleich fortgesetzt werden.
		\end{enumerate}
		%
	\subsection{Fazit}
